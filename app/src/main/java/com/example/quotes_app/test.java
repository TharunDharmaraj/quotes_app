...
public class test extends AppCompatActivity {
    ...
    private Button verifyOTPBtn, generateOTPBtn, testBtn;
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(test.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    ...
                    Toast.makeText(test.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openDialog() {
        dialog.setContentView(R.layout.activity_dialog_verification_unsuccessful);
