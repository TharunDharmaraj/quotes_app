...
public class ForgotPasswordVerification extends AppCompatActivity {
    ...
    private final PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(ForgotPasswordVerification.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resendCode.setOnClickListener(v -> {
            ...
            InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
            imm.hideSoftInputFromWindow(v.getWindowToken(), 0);
            Toast.makeText(ForgotPasswordVerification.this, "verification code resent", Toast.LENGTH_SHORT).show();
        });
    }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(ForgotPasswordVerification.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void openDialog() {
        ...
        enterPassword.setOnClickListener(v -> {
            Intent i = new Intent(ForgotPasswordVerification.this, RetypePassword.class);
            startActivity(i);
            finish();
        });
        dialog.show();
    ...
    private void verifyCode(String code) {
        try {
            ...
            Toast.makeText(ForgotPasswordVerification.this, "Wrong Code.. \nPlease Verify2", Toast.LENGTH_SHORT).show();
        }
    }
}